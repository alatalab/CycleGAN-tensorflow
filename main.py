...
parser.add_argument('--dataset_dir', dest='dataset_dir', default='human2map', help='path of the dataset')
...
parser.add_argument('--fine_size', dest='fine_size', type=int, default=384, help='then crop to this size')
...
parser.add_argument('--max_size', dest='max_size', type=int, default=25, help='max size of image pool, 0 means do not use image pool')
